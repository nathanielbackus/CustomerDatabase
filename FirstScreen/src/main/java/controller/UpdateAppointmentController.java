...
public class UpdateAppointmentController implements Initializable {
    ...
    private TextField AppointmentLocationTextField, AppointmentCustomerIDTextField, AppointmentDescriptionTextField,
            AppointmentTitleTextField, AppointmentTypeTextField, AppointmentUserIDTextField, AppointmentID;
    @FXML
    private DatePicker AppointmentStartDateDatePicker, AppointmentEndDateDatePicker;
    @FXML
    private ComboBox<?> AppointmentStartTimeComboBox, AppointmentEndTimeComboBox, ContactComboBox;
    @FXML
